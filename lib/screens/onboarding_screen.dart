...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  Map<String, Map<String, dynamic>> _getLevelDescriptions(BuildContext context) {
    return {
      ...
      'B1': {
        'title': 'Intermediate',
        'description': 'Can handle most situations while traveling. Can describe experiences and events.',
      },
      'B2': {
        'title': 'Upper Intermediate',
        'description': 'Can interact with fluency and spontaneity. Can produce clear, detailed text.',
      },
      'C1': {
        'title': 'Advanced',
        'description': 'Can express themselves fluently and spontaneously for social and professional purposes.',
      },
      'C2': {
        'title': 'Proficient',
        'description': 'Can understand virtually everything with ease and express themselves very fluently.',
      },
    };
  }
  ...
  Future<void> _completeOnboarding() async {
    ...
    try {
      ...
      if (mounted) {
        // Navigate to chat screen (pop this screen)
