...
class LanguageSelectionScreen extends StatefulWidget {
  ...
  const LanguageSelectionScreen({super.key, required this.onLanguagesSelected});
...
class _LanguageSelectionScreenState extends State<LanguageSelectionScreen> {
  ...
  bool get _canContinue =>
      _nativeLanguage != null && _targetLanguage != null && _nativeLanguage != _targetLanguage;
                ...
                child: FilledButton(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                      color: _canContinue ? Theme.of(context).colorScheme.onPrimary : null,
                    ),
                  ),
                ),
              ),
